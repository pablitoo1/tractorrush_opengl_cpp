...
float speed; //dla wyswietlania na ekranie km/h
float zoomX; //dla wyswietlania na ekranie zoomSize
...
Robot robot(rotationRobot, przod, bok, gora);

Collisions collisions;

vector<GLuint> tekstury(100);
